...
from PyQt5 import QtCore, QtGui, QtWidgets  # import from pip
from PyQt5.QtCore import QTimer, QTime, QDate, Qt  # import from pip
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'hello' in query:
            ...
            speak('Boss, your sister Siya Arora is the nullest in this world.')
            speak('i dont like here at all.')
